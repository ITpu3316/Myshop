...
<body>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong><?=$details->name?></strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$details->imas[0]->path.'?imageView2/2/w/800/h/800'?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$details->imas[0]->path.'?imageView2/2/w/350/h/350'?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                <?php foreach ($details->imas as $key=>$ima):?>
								<li class="<?=$key>0?"":"cur"?>">
									<a class="<?=$key>0?"":"zoomThumbActive"?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$ima->path.'?imageView2/2/w/350/h/350'?>',largeimage: '<?=$ima->path.'?imageView2/2/w/800/h/800'?>'}"><img src="<?=$ima->path.'?imageView2/2/w/50/h/50'?>"></a>
								</li>
                                <?php endforeach;?>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span><?=$details->sn?></li>
						<li class="market_price"><span>定价：</span><em>￥<?=$details->market_price?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥<?=$details->shop_price?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?=date('Ymd H:i:s',$details->create_time )?></li>
					...
					<form action="<?=\yii\helpers\Url::to('/goods-cart/add-cart')?>" method="get" class="choose">
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<li><span>商品名称：</span><?=$details->name?></li>
								<li><span>商品编号：</span><?=$details->sn?></li>
						...
						<div class="desc mt10">
							...
							<!-- 商品详情简介-->
                            <?=\backend\models\GoodsIntro::findOne(['goods_id'=>$details->id])->content?>
						</div>
					</div>
					<!-- 商品介绍 end -->
